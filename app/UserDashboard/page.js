...
//         filters.city.forEach((c) => c.trim() && params.append("city", c.trim()));
//       } else if (cityQuery?.trim()) {
//         params.append("city", cityQuery.trim());
//       }

//       if (filters.category?.length > 0) {
//         filters.category.forEach((cat) => cat.trim() && params.append("category", cat.trim()));
//       }
...
//                 >
//                   <h5 className="mb-2 text-2xl font-semibold" style={{ color: biz.color }}>
//                     {biz.name}
//                   </h5>
//                   <p className="mb-3 text-gray-500">{biz.description}</p>
//                   <p className="text-blue-600 hover:underline">{biz.category}</p>
